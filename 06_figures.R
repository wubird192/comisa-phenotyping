...
# 06_figures.R — Publication-ready figures
#
...
# Dimensions follow journal artwork guidelines:
...
# Shared ggplot theme
journal_theme <- theme_minimal(base_size = 10, base_family = "Arial") +
  theme(
...
# save_fig: saves PNG (preview) + TIFF (journal submission, 300 DPI).
...
common_umap_theme <- journal_theme +
...
save_fig(fig1, "Figure1_COMISA_Phenotypes", 180, 160)
cat("\n")
...
save_fig(p2, "Figure2_ISI_vs_AHI_Scatter", 140, 140)
cat("\n")
...
save_fig(fig3, "Figure3_Clinical_Variables", 180, 240)
cat("\n")
...
ggsave(file.path(OUTPUT_DIR, "FigureS2_Clinical_Heatmap.png"),
       fig_s2, width = 180, height = 220, units = "mm", dpi = 300)
cat("  \u2713 FigureS2_Clinical_Heatmap.png saved\n\n")
...
#
#   NOTE: The threshold comparison is reported as a numeric table
#   (AUC/sensitivity/specificity; see Supplementary Table S2). This block
#   still generates the ROC figure and FigureS1_AUC_Comparison.csv for
#   internal reference. The underlying data (AUC values, DeLong P) feed
#   into TableS2_AHI_Sensitivity_Analysis.csv generated by 07_tables.R.
# ============================================================
